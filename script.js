...
function dirijeSouPajChat() {
    ...
    // Tcheke si navigatè a sipòte notifikasyon anvan nou mande pèmisyon
...
function listenForMessages() {
    ...
    messagesRef.off();
        ...
        // Voye notifikasyon sèlman si navigatè a kapab fè sa
        if (data.sender !== myId) {
            if ('Notification' in window && Notification.permission === "granted") {
...
// Enstale aplikasyon an sou telefòn (Vèsyon Korèk)
if ('serviceWorker' in navigator) {
  navigator.serviceWorker.register('./sw.js')
    .then(reg => console.log("Service Worker anrejistre ak siksè! 🎉"))
    .catch(err => console.log("Service worker pa anrejistre:", err));
}
